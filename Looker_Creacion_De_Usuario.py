...
# Diciembre de 2024
# Este código muestra un ejemplo de como crear un usuario
# en una instancia de Looker Platform
...
# A continuación define los datos del nuevo usuario
...
# Entonces para crear el usuario en Looker
try:
